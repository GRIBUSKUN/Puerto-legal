...
<html>
   ...
   <body>
      <div class="header_section">
         <div class="container-fluid" style="background-color:#001431;">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="what-we.html">Servicios</a>
                     </li>
                     <li class="nav-item">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Brindamos asesorías legales</h1>
