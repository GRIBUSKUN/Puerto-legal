    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Ofrecemos práctica jurídica.</h1>
                                 <p class="banner_text">Cicerón, escrito en el 45 a.C. Este libro es un tratado sobre la teoría de la ética, muy popular durante el Renacimiento. La primera línea de Lorem.</p>
                                 <div class="readmore_btn active"><a href="#">Leer mas</a></div>
                                 <div class="started_bt"><a href="#">Contactanos</a></div>
                              </div>
                           </div>
                           <div class="col-md-6">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 ...
                                 <div class="readmore_btn active"><a href="#">Leer Más</a></div>
                                 <div class="started_bt"><a href="#">Contactanos</a></div>
                              </div>
                           </div>
                           <div class="col-md-6">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 ...
                                 <p class="banner_text">Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem</p>
                                 <div class="readmore_btn active"><a href="#">Leer Más</a></div>
                                 <div class="started_bt"><a href="#">Contacto</a></div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="banner_img"><img src="images/banner-img.png"></div>
      ...
      <div class="customer_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="customer_taital">Comentarios de nuestros clientes</h1>
               </div>
            </div>
         </div>
      ...
      <div class="news_section layout_padding">
         <div class="container">
            <h1 class="news_taital">Noticias recientes</h1>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="footer_logo">
                  <a href="indexz.html">
                     <img src="images/logo.svg" style="width:174px; filter:invert(1);">
               </div>
